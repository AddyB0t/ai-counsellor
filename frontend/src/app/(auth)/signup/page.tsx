    ...
    <div className="min-h-screen bg-white dark:bg-[#0f1419] flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm sm:text-base">Start your study abroad journey</p>
        </div>
          ...
          {success && (
            <div className="bg-emerald-50 dark:bg-emerald-500/10 p-4 rounded-xl border border-emerald-200 dark:border-emerald-500/20">
              <div className="flex items-center gap-3">
                {/* Lucide CheckCircle */}
                <svg className="w-6 h-6 text-emerald-600 dark:text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <circle cx="12" cy="12" r="10"/>
                  <path d="m9 12 2 2 4-4"/>
                </svg>
                <div>
                  <p className="text-emerald-800 dark:text-emerald-200 font-medium">Check your email!</p>
                  <p className="text-emerald-600 dark:text-emerald-400 text-sm mt-1">
                    We sent a verification link to <strong>{email}</strong>. Click the link to verify your account, then come back to login.
                  </p>
                </div>
              </div>
              <Link
                href="/login"
                className="mt-4 block w-full text-center bg-gradient-to-r from-emerald-500 to-green-500 text-white py-2.5 rounded-xl font-medium hover:shadow-lg hover:shadow-emerald-500/25 transition-all"
              >
                Go to Login
              </Link>
            </div>
